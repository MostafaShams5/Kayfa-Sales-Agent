...
class KayfaDataCompiler:
    ...
    def _parse_markdown_table(self, filename: str) -> List[Dict[str, str]]:
        ...
        for line in lines:
            ...
            if set(c.replace('-', '') for c in cells) == {''}:
                continue
    ...
    def enrich_courses(self) -> None:
        ...
        for pc in paid_courses:
            ...
            price_str = pc.get(price_key, '0') if price_key else '0'
    ...
    def enrich_roadmaps(self) -> None:
        ...
        for pt in paid_tracks:
            ...
            price_str = pt.get(price_key, '0') if price_key else '0'
        ...
        for roadmap in self.roadmaps:
            ...
            roadmap.update(track_enrichment.get(name_norm, {'price': None, 'currency': 'USD'}))
...
if __name__ == "__main__":
    compiler = KayfaDataCompiler(data_dir="./data")
